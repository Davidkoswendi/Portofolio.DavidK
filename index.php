...
<body>
    <nav>
        <div class="nav-container">
            <div class="logo">
                <img src="img/Black_Circle_Icon_Business_Logo-removebg-preview.png" alt="Logo">
            </div>
            <div class="links">
                <a href="#home">Home</a>
        ...
        <div class="certificates" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="400">
            ...
            <div class="certificate-list">
                <div class="certificate-item">
                    <img src="img/Sertifikat1.png" alt="Certificate 1">
                    <a href="Sertifikat_Pelatihan_Digitalent.pdf" target="_blank" view="Sertifikat_Pelatihan_Digitalent.pdf" class="download-button">View</a>
                </div>
                <div class="certificate-item">
                    <img src="img/Sertifikat2.png" alt="Certificate 2">
                    <a href="Sertifikat_PPLG.pdf" target="_blank" view="Sertifikat_PPLG.jpg" class="download-button">View</a>
                </div>
            </div>
        </div>
    </div>
...
<section id="portfolio">
    <div class="portfolio-content">
        ...
        <div class="portfolio-list">
            ...
            <div class="portfolio-item" data-aos="flip-left" data-aos-duration="1500" data-aos-delay="600">
                <img src="img/Tefa.png" alt="Project 4">
                <h3>Project Tefa</h3>
                <p>Creating a talent pool registration website for JagoIT company</p>
            </div>
        </div>
    </div>
</section>
...
<section id="programming-languages">
    <div class="programming-content">
        ...
        <div class="skills-container">
            ...
            <div class="skill-item" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="600">
                <div class="skill-icon">
                    <img src="img/LARAVEL (1).png" alt="Laravel Logo">
                </div>
                <div class="skill-details">
                    <h4>Laravel</h4>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addEventListener('scroll', function() {
        if (!isScrolling) {
            portfolioList.style.animationPlayState = 'paused';
            isScrolling = true;
        }
        ...
        window.scrollTimeout = setTimeout(function() {
            portfolioList.style.animationPlayState = 'running';
            isScrolling = false;
